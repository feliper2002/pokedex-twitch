                ...
                Expanded(
                  child: Observer(builder: (_) {
                    return FutureBuilder(
                      ...
                      builder:
                          (context, AsyncSnapshot<List<PokeAPI>?> snapshot) {
                        return snapshot.data != null
                            ? ListView.builder(
                                padding:
                                    const EdgeInsets.symmetric(horizontal: 40),
                                itemCount:
                                    pokeController.getFilteredText()!.length,
                                itemBuilder: (context, index) {
                                  ...
                                  return PokeCard(
                                    ...
                                    primaryType:
                                        poke.primaryType!.names!.english,
                                    secondaryType: poke.secondaryType != null
                                        ? poke.secondaryType!.names!.english
                                        : '',
                                  );
                                },
                              )
